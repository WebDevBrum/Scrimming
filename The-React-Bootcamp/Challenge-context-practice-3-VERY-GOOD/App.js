            ...
            <div>
                <Header />
                    <UserContextConsumer>
                        {username => (
                            <main>
                            <p className="main">No new notifications, {username.username}! 🎉</p>
                        <input
                            type="text"
                            name="newUsername"
                            placeholder="New username"
                            value={this.state.newUsername} //was ???
                            onChange={this.handleChange}
                        />
                        <button onClick={() => username.changeUserName(this.state.newUsername)}>Change Username</button>
                        </main>
                                )}
                    </UserContextConsumer> 
            </div>
